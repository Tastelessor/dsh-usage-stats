...
export const zh = {
  ...
  priceRestoreDefault: '恢复默认',
  priceRestoring: '恢复中…',
  priceRestoreFailed: '恢复失败，请重试',
...
export const en = {
  ...
  priceRestoreDefault: 'Restore defaults',
  priceRestoring: 'Restoring…',
  priceRestoreFailed: 'Restore failed, please retry',
